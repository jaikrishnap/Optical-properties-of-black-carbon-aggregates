...
if __name__ == '__main__':
    ...
    def config():
        params = dict(
            split='multiple runs to check loss function fractal dimension split',
    ...
    def main(params, _run):
        ...
        for losses in ['mean_squared_error', 'huber_loss', 'logcosh']:
            ...
            for i in range(0, params.max_runs):
                ...
                filepath = f"fractal_dimension_split_run_{i}/best_model.hdf5"
                with make_experiment_tempfile('best_model.hdf5', _run, mode='wb', suffix='.hdf5') as model_file:
                    ...
                    weights_file = f'fractal_dimension_split_run_{i}/best_model.hdf5'  # choose the best checkpoint
